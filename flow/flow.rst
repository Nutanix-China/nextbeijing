...
在界面**Explore > VMs > **flow-<your_initials>-2 > Actions > Unquarantine VM** 取消对 **flow-<your_initials>-2** 的隔离.
...
通过复选框选中 **flow-<your_initials>-1** 和 **flow-<your_initials>-2** ，并打开两个虚拟机的控制台
